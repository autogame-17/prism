...
import (
	...
	"one-api/providers/subscriptioncli"
...
func init() {
	providerFactories = map[int]ProviderFactory{
		...
		config.ChannelTypeChatGPTSubscription: subscriptioncli.ProviderFactory{},
		config.ChannelTypeClaudeSubscription:  subscriptioncli.ProviderFactory{},
	}
}
